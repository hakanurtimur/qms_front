...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-primary-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-primary-950 focus:ring-offset-2 dark:border-primary-800 dark:focus:ring-primary-300",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary-900 text-primary-50 shadow hover:bg-primary-900/80 dark:bg-primary-50 dark:text-primary-900 dark:hover:bg-primary-50/80",
        secondary:
