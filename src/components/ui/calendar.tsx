  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-primary-500 rounded-md w-8 font-normal text-[0.8rem] dark:text-primary-400",
        ...
        day_outside:
          "day-outside text-primary-500 aria-selected:bg-primary-100/50 aria-selected:text-primary-500 dark:text-primary-400 dark:aria-selected:bg-primary-800/50 dark:aria-selected:text-primary-400",
