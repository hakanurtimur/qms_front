...
import MainDocTable from "./_components/main-doc-table";
...
import MainDocSheet from "./_components/main-doc-sheet";
import DocumentMasterHistoryModal from "./_components/history-modal";
import HistorySheet from "./_components/history-sheet";
import useDocumentMainList from "./hooks/useDocumentMainList";
import useDocumentGetById from "./hooks/useDocumentGetById";
import useIssueTypeList from "../waiting-requests/hooks/useIssueTypeList";
import { RequestDocumentCreatedModel } from "@/models/user/documents/documents/requestDocumentCreate";
import useDocumentUpdateHistory from "./hooks/useDocumentUpdateHistory";
import useDocumentHistoryList from "./hooks/useDocumenHistoryList";
import useDocumentHistoryGetById from "./hooks/useDocumentHistoryGetById";
import useDocumentHistoryUpdateDetails from "./hooks/useDocumentHistoryUpdateDetails";
