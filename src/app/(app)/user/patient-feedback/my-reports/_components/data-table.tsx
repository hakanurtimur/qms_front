...
import PatientFeedbackMyAllReportsSheet from "./all-my-reports/my-reports-sheet";
import PatientFeedbackMyDutiesSheet from "./my-assigned-duties/my-duties-sheet";
              ...
              {table.getRowModel().rows?.length ? (
                table.getRowModel().rows.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell>
                      {variant === "all" ? (
                        <PatientFeedbackMyAllReportsSheet />
                      ) : null}
                      {variant === "actives" ? (
                        <PatientFeedbackMyDutiesSheet />
                      ) : null}
                    </TableCell>
                  </TableRow>
                ))
